<h1 align="center">Gabriel Diniz</h1>
<p align="center"><em>Programador em construção · Curitiba, Brasil 🇧🇷</em></p>
...
Estou aprendendo programação **na prática** — construindo, errando e iterando em público.
Foco atual: **automação, agentes de IA e ferramentas que resolvem problemas reais.**

- 🔭 **Estudando agora:** Python, JavaScript/TypeScript e Git/GitHub
- 🤖 **Explorando:** orquestração de agentes (Claude Code, MCP, tmux)
- 🌱 **Próximos projetos:** automações de produtividade, mini-agentes em Python e um site portfólio
- 💡 **Filosofia:** *shipping > perfeccionismo*
...
<p align="center"><sub>Este README é atualizado conforme eu evoluo. Volte sempre. 🚀</sub></p>
